        ...
        <div class="container mt-5">
            <div class="row justify-content-center">
                <div class="col-lg-12 col-md-12">
                    <div class="card bg-secondary border-0" style="box-shadow:
                        0px 2px 10px rgba(0,0,0,0.2),
                        0px 10px 20px rgba(0,0,0,0.3),
                        0px 30px 60px 1px rgba(0,0,0,0.5);
                      border-radius: 8px;">
                        <div class="card-header bg-transparent text-primary mx-4">
                            <small style="font-size:16px;">اضافة كتاب</small>
                        </div>
                        <div class="card-body px-lg-5 py-lg-5">
                            <div class="text-center text-muted mb-4">
                            </div>
                            <form role="form" name="addBookForm" method="post" id="addBookForm">
                                ...
                                <div class="form-group mb-3">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control border-0 shadow px-2"
                                               style="border-radius:4px 0 0 4px; margin-right:-2px" required name="signDate"
                                               id="signDate" value=""
                                               oninput="this.setCustomValidity('')" placeholder="signDate">
                                    </div>
                                    <small id="signDate_err" class="form-text text-danger"></small>
                                </div>
                                <div class="mb-3">
                                    <div>
                                        <textarea style="border-radius:4px 0 0 4px;"
